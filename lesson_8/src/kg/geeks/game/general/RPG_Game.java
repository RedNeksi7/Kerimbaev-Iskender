...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Kamikadze kamikadze= new Kamikadze(600, 0, "KamikadzeDead");
        Thor thor=new Thor(200,30, "Odin");
        TrickyBastard trickyBastard=new TrickyBastard(300, 10, "Tricky");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, kamikadze, thor, trickyBastard};
