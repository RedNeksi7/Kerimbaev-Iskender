...
class OnBoardingAdapter(private val onClick:()->Unit):Adapter<OnBoardingAdapter.OnBoardingViewHolder>() {
    val list= listOf(
        OnBoarding("https://img.geliophoto.com/bishkek/00_bishkek.jpg", "Бишкек", "Население: 1071261ч."),
        OnBoarding("https://24.kg/files/media/79/79892.jpg", "Чолпон-Ата", "12500ч."),
        OnBoarding("https://issyk-kul-rest.narod.ru/karakol/img/ski-20.jpg", "Каракол", "82000ч.")
    )
